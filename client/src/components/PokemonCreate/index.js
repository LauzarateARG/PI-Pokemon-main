...
function validate(input) {
  ...
  if (!input.name) {
  ...
  } else if (input.height > 20) {
    errors.name = "el pokemon es demasiado alto, altura maxima 20m";
    ...
    errors.name = "el pokemon tiene poco peso, su peso tiene que ser mayor a 0";
